...
- Oracle may reclaim idle free-tier instances. Keep it active by ensuring CartPath receives regular traffic.
- Set up a simple uptime check (e.g., UptimeRobot, free) to ping `/api/health` every 5 minutes.
